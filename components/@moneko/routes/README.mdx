...
> 或参考 [demo](https://github.com/moneko-o/demo-micro-app-solid)
...
> React 应用与 Solid应用稍有差别, 具体可参考 [React demo](https://github.com/moneko-o/demo-micro-app-react) 和 [Solid demo](https://github.com/moneko-o/demo-micro-app-solid)
